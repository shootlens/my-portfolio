                ...
                <div className="flex items-center justify-between flex-wrap pt-[3%]">
                    <div className="w-1/2 h-[500px] flex items-center justify-center">
                        <div className="flex items-start justify-start flex-col space-y-5">
                            <div className="text-5xl text-white font-medium">Hi There</div>
                            <div className="text-7xl text-green-500 font-semibold">I'm Raghavendra</div>
                            <div className="text-2xl text-green font-medium px-2 rounded-md bg-white">UI DEVELOPER</div>
